...
const CommandeItem = (props) => {
    ...
    return (
        <TouchableOpacity
            onPress={() => props.navigation.navigate("Réservé", {item: item})}
            style={styles.item}
        >
            ...
            <View style={{ marginLeft: 60 }}>
                ...
                <View style={{ marginLeft: 60, justifyContent: "space-evenly" }}>
                    <CustomButton primary               onPress={() => props.navigation.navigate("Réservé", {item: item})}
>
